<?php
  ...
  //conexión a la base de datos
   ...
   class Perfil extends Conectar{
        ...
        public function get_usuario_nombre($dni, $correo){
       ...
       public function editar_perfil($id_usuario_perfil,$nombres_perfil,$apellidos_perfil,$dni_perfil,$telefono_perfil,$correo_perfil,$direccion_perfil,$usuario_perfil,$password_perfil,$password2_perfil){
          ...
          $sql->bindValue(1,$_POST["nombres_perfil"]);
          $sql->bindValue(2,$_POST["apellidos_perfil"]);
          $sql->bindValue(3,$_POST["dni_perfil"]);
          $sql->bindValue(4,$_POST["telefono_perfil"]);
          $sql->bindValue(5,$_POST["correo_perfil"]);
