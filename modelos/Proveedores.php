<?php
   ...
   class Proveedor extends Conectar{
        ...
        public function registrar_proveedor($dni,$proveedor,$telefono,$correo,$direccion,$estado,$id_usuario){
        ...
        $sql="select * from proveedor where id_proveedor=? and estado=?";
         ...
         public function editar_proveedor($dni,$proveedor,$telefono,$correo,$direccion,$estado,$id_usuario){
