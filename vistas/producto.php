              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">
                            <button class="btn btn-primary btn-lg" id="add_button" onclick="limpiar().reset()" data-toggle="modal" data-target="#productoModal"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Producto</button></h1>
  ...
  <div class="modal-dialog modal-lg" >
    <form class="form-horizontal" method="post" id="producto_form" enctype="multipart/form-data">
          ...
          <div class="box">
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-9 col-lg-offset-1">
                   ...
                   <input type="text" class="form-control" id="producto" name="producto" placeholder="Descripción Producto" >
      ...
      <input type="file" id="producto_imagen" name="producto_imagen">
              ...
              <span id="producto_uploaded_imagen"></span>
      ...
      <!--section formulario - agregar- producto -->
           ...
           <div class="row">
               ...
               <div class="col-lg-8 col-lg-offset-3 col-sm-8"> 
...
$(document).ready(function(){
    ...
    $(#productoModal).on('hidden',function(e){
      this.removedata('productoModal');
      this.find('.productoModal').empty();
  })
})
<script>
    $(document).ready(function(){
