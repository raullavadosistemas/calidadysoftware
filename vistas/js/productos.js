...
function registrarCompre() {
    ...
    if (dni != "" && razon != "" && direccion != "" && tipo_pago != "" && detalles != "") {
        ...
        $.ajax({
            ...
            method: "POST",
            data: { 'arrayCompra': JSON.stringify(detalles), 'numero_compra': numero_compra, 'dni': dni, 'razon': razon, 'direccion': direccion, 'total': total, 'comprador': comprador, 'tipo_pago': tipo_pago, 'id_usuario': id_usuario, 'id_proveedor': id_proveedor },
            cache: false,
            dataType: "html",
