...
//llamo a la conexion de la base de datos 
  ...
  $perfil = new Perfil();
   ...
   $nombres_perfil=isset($_POST["nombres_perfil"]);
   $apellidos_perfil=isset($_POST["apellidos_perfil"]);
   $dni_perfil=isset($_POST["dni_perfil"]);
   $telefono_perfil=isset($_POST["telefono_perfil"]);
   $correo_perfil=isset($_POST["correo_perfil"]);
  ...
  $datos=$perfil->get_usuario_por_id($_POST["id_usuario_perfil"]);
    ...
    $datos= $perfil->get_usuario_nombre($_POST["dni_perfil"], $_POST["correo_perfil"]);
   ...
   if($_POST["password_perfil"]==$_POST["password2_perfil"]){
            ...
            $perfil->editar_perfil($id_usuario_perfil,$nombres_perfil,$apellidos_perfil,$dni_perfil,$telefono_perfil,$correo_perfil,$direccion_perfil,$usuario_perfil,$password_perfil,$password2_perfil);
